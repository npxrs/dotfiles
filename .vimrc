...
"--------------=== Поддержка сниппетов ===---------------
Plugin 'Shougo/neocomplete'             " Snippets manager
...
" Enabel snipMate compatibility feature
let g:neosnippet#enable_snipmate_compatibility = 1
" Tell Neosnippet about the other snippers
